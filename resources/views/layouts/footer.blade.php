    ...
    <div class="container p-6">
      ...
      <div class="">
        ...
        <p class="flex justify-center items-center">
          <img
            src="https://media.discordapp.net/attachments/902133591272730654/961667287419617351/Explore_new_opportunities.png" class="mt-3 max-w-full h-20 rounded-full mb-7" alt="">
